package com.example.whatsapp.presentation.splashscreen.bottomnavigation
...
fun BottomNavigation(navHostController: NavHostController,onClick:(index: Int)-> Unit,selectedItem: Int
    ...
    val items = listOf(NavigationItem("Chats", R.drawable.chat_icon, R.drawable.outline_chat_24),
